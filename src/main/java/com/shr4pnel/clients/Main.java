...
/**
 * Starts all the clients (user interface) as a single application. Good for testing the system
...
class Main {
  ...
  /**
   * start the Packing client - for warehouse staff to pack the bought order for customer, one order
   * at a time
   *
   * @param mlf A factory to create objects to access the stock list
   */
