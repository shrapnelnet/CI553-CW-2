...
public class WebApplication {
    ...
    @Operation(summary = "Buy new stock", description = "Adds specified amount of stock to the database", responses = {@ApiResponse(responseCode = "204", description = "Successful addition of new stock to database", content = @Content(schema = @Schema(hidden = true))), @ApiResponse(responseCode = "403", description = "Attempt to add less than zero of more than 99 items at a time", content = @Content(schema = @Schema(hidden = true))), @ApiResponse(responseCode = "500", description = "Server cannot connect to database", content = @Content(schema = @Schema(hidden = true)))})
