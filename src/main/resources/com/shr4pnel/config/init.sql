CREATE TABLE ProductTable ( productNo CHAR(4) PRIMARY KEY, description VARCHAR(40), picture VARCHAR(80), price FLOAT)
...
CREATE TABLE StockTable (productNo  CHAR(4) PRIMARY KEY, stockLevel INTEGER)
